...
{
    internal class Shop(ref Player player)
    {
        public List<Consumable> _consumableList = new List<Consumable>() { new HealthPotion(ref player, "Basic Health Potion", "", 10, 5),
                                                                           new HealthPotion(ref player, "Advanced Health Potion", "", 25, 10),
                                                                           new HealthPotion(ref player, "Super Health Potion", "", 50, 20) };
        ...
        public void ShopMenu(ref Player player, TownMenu shopType)
        {
            int itemInput;
